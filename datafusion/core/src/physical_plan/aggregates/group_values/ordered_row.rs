...
/// A [`GroupValues`] making use of [`Rows`], in which all group rows
/// are stored according to input order and can be emitted accordingly.
pub struct OrderedGroupValuesRows {
...
impl GroupValues for OrderedGroupValuesRows {
